...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2503450143227217706, ; hash 0x22be0aa433f5872a, from name: aot-MVVMFruits
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MVVMFruits.dll.so
		ptr null; void* handle (0x0)
	}, ; 62
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 11544235039130396179, ; hash 0xa0355c9aa6fc2613, from name: MVVMFruits
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MVVMFruits.dll.so
		ptr null; void* handle (0x0)
	}, ; 295
	...
	%struct.DSOCacheEntry {
		i64 12102694886436910470, ; hash 0xa7f568e05b023586, from name: libaot-MVVMFruits.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MVVMFruits.dll.so
		ptr null; void* handle (0x0)
	}, ; 310
	...
	%struct.DSOCacheEntry {
		i64 14975821817636085380, ; hash 0xcfd4ce990bbe5e84, from name: MVVMFruits.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MVVMFruits.dll.so
		ptr null; void* handle (0x0)
	}, ; 391
	...
	%struct.DSOCacheEntry {
		i64 15737791072726653348, ; hash 0xda67dd99272f99a4, from name: libaot-MVVMFruits
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MVVMFruits.dll.so
		ptr null; void* handle (0x0)
	}, ; 409
	...
	%struct.DSOCacheEntry {
		i64 18246575072162701992, ; hash 0xfd38db5a87c162a8, from name: aot-MVVMFruits.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MVVMFruits.dll.so
		ptr null; void* handle (0x0)
	}, ; 469
...
@.env.3 = private unnamed_addr constant [37 x i8] c"e649c14e-8f4e-4d01-8706-9d4a2a4a438d\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.mvvmfruits\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [25 x i8] c"libaot-MVVMFruits.dll.so\00", align 16
