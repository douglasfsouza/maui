...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1524085473, ; hash 0x5ad7b2e1, from name: libaot-MVVMFruits
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1918626366, ; hash 0x725bea3e, from name: aot-MVVMFruits
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MVVMFruits.dll.so
		ptr null; void* handle (0x0)
	}, ; 203
	...
	%struct.DSOCacheEntry {
		i64 1966572796, ; hash 0x753784fc, from name: aot-MVVMFruits.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MVVMFruits.dll.so
		ptr null; void* handle (0x0)
	}, ; 211
	...
	%struct.DSOCacheEntry {
		i64 2794210881, ; hash 0xa68c4641, from name: libaot-MVVMFruits.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MVVMFruits.dll.so
		ptr null; void* handle (0x0)
	}, ; 315
	...
	%struct.DSOCacheEntry {
		i64 3275238778, ; hash 0xc3382d7a, from name: MVVMFruits
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MVVMFruits.dll.so
		ptr null; void* handle (0x0)
	}, ; 376
	...
	%struct.DSOCacheEntry {
		i64 3384267439, ; hash 0xc9b7d2af, from name: MVVMFruits.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MVVMFruits.dll.so
		ptr null; void* handle (0x0)
	}, ; 387
