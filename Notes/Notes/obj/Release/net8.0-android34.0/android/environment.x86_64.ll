...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2197323943853694265, ; hash 0x1e7e767c29dc1d39, from name: aot-SimpleNotes.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SimpleNotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 50
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4445815349018242301, ; hash 0x3db2b58147362cfd, from name: libaot-SimpleNotes
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SimpleNotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 112
	...
	%struct.DSOCacheEntry {
		i64 8048956115238695324, ; hash 0x6fb3a2f10d82b19c, from name: libaot-SimpleNotes.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SimpleNotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 192
	...
	%struct.DSOCacheEntry {
		i64 13051370821299925307, ; hash 0xb51fc89ce37af13b, from name: aot-SimpleNotes
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SimpleNotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 334
	...
	%struct.DSOCacheEntry {
		i64 18150656545146732649, ; hash 0xfbe415f625970069, from name: SimpleNotes
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SimpleNotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 467
	...
	%struct.DSOCacheEntry {
		i64 18411252441427645584, ; hash 0xff81e88c69569490, from name: SimpleNotes.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-SimpleNotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 478
...
@.env.3 = private unnamed_addr constant [37 x i8] c"44e7645e-483a-4940-834b-d98da1b4833f\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [31 x i8] c"com.electrasystems.simplenotes\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [26 x i8] c"libaot-SimpleNotes.dll.so\00", align 16
